...
public class Country {
    ...
    public Country(String code, String name, String continent, String region, Double surfaceArea, Integer indepYear, Integer population, Double lifeExpectancy, Double GNP, Double GNPOld, String localName, String governmentForm, String headOfState, Integer capital, String code2, List<City> city, List<CountryLanguage> countryLanguage) {
        this.code = code;
        this.name = name;
    ...
    public void setCountryLanguages(List<CountryLanguage> countryLanguage) {
        this.countryLanguage = countryLanguage;
    }
}
